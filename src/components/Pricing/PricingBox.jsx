...
const PricingBox = ({ price, duration, packageName, subtitle, children }) => {
  return (
     <div className="w-full">
       ...
       dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark">
         ...
         dark:border-white dark:border-opacity-10">
           <button className="flex w-full items-center justify-center rounded-sm
         ...
         <div className="absolute bottom-0 right-0 z-[-1]">
           ...
           >
             ...
             <path
                opacity="0.3"
                d="M178.255 0.150879C129.388 56.5969 134.648 155.224 143.387 197.482C157.547 265.958 65.9705 295.709
                53.1024 246.401C34.2588 174.197 100.939 83.7223 178.255 0.150879Z"
