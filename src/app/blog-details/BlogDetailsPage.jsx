...
const BlogDetailsPage = () => {
  return (<section className="blog-details-section">
    <div className="blog-container">
      <div className="blog-row">
        <div className="blog-col">
          <h2 className="blog-title">
            Sample: 10 amazing sites to download stock photos & digital assets for free
          </h2>
              ...
              <p className="meta-item">
                  <span className="meta-icon">
                    ...
                    >
                            ...
                            <path d="M13.2637 3.3697H7.64754V2.58105C8.19721 2.43765 8.62738 1.91189 8.62738 1.31442C8.62738 0.597464 8.02992 0 7.28906 0C6.54821 0 5.95074 0.597464 5.95074 1.31442C5.95074 1.91189 6.35702 2.41376 6.93058 2.58105V3.3697H1.31442C0.597464
                            3.3697 0 3.96716 0 4.68412V13.2637C0 13.9807 0.597464 14.5781 1.31442 14.5781H13.2637C13.9807 14.5781 14.5781 13.9807 14.5781 13.2637V4.68412C14.5781 3.96716 13.9807 3.3697 13.2637 3.3697ZM6.6677 1.31442C6.6677 0.979841 6.93058 0.716957 7.28906
                            0.716957C7.62364 0.716957 7.91042 0.979841 7.91042 1.31442C7.91042 1.649 7.64754 1.91189 7.28906 1.91189C6.95448 1.91189 6.6677 1.6251 6.6677 1.31442ZM1.31442 4.08665H13.2637C13.5983 4.08665 13.8612 4.34954 13.8612 4.68412V6.45261H0.716957V4.68412C0.716957
                            4.34954 0.979841 4.08665 1.31442 4.08665ZM13.2637 13.8612H1.31442C0.979841 13.8612 0.716957 13.5983 0.716957 13.2637V7.16957H13.8612V13.2637C13.8612 13.5983 13.5983 13.8612 13.2637 13.8612Z"/>
                          </svg>
                  </span>
                12 Jan 2024
              </p>
          ...
          <div className="blog-image">
            <img src="../../../public/images/blog/blog-details-02.jpg" alt="blog"/>
          </div>
          
          <p className="blog-paragraph">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
            et dolore magna aliqua.
            <strong className="highlight"> malesuada </strong>
          ...
          <p className="blog-paragraph">
            ...
            <span className="highlight underline"> Amet dictum sit amet justo </span>
          ...
          <div className="quote-box">
            ...
            <span className="quote-bg">
                <svg width="132" height="109" viewBox="0 0 132 109" fill="none">
                  {/* Keep your <linearGradient> and <defs> here */}
                  <svg
                     width="132"
                     height="109"
                     viewBox="0 0 132 109"
            ...
            <span className="quote-bg">
                <svg width="53" height="30" viewBox="0 0 53 30" fill="none">
                  {/* Keep your <mask>, <filter>, <radialGradient> here */}
